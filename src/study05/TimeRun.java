...
public class TimeRun {
	...
	public static void main(String[] args) {	
		//java.time 기본 클래스
		//LodcalDate(날짜), LocalTime(시간), LocalDateTIme(모두)
		//ZondeDateTime
		...
		System.out.println(date.getDayOfWeek().getValue());  //요일(숫자)
		...
		LocalDate dow = dt.with(TemporalAdjusters.firstInMonth(DayOfWeek.THURSDAY)); //첫 주 목요일
		System.out.println(dow); 
		LocalDate dow2 = dt.with(TemporalAdjusters.lastInMonth(DayOfWeek.THURSDAY)); //마지막 주 목요일
		System.out.println(dow2);
		LocalDate dow3 = dt.with(TemporalAdjusters.previous(DayOfWeek.THURSDAY)); 	//전 주 목요일
		System.out.println(dow3);
		LocalDate dow4 = dt.with(TemporalAdjusters.previousOrSame(DayOfWeek.MONDAY)); //오늘이나 저번주 월요일
		System.out.println(dow4);
		LocalDate dow5 = dt.with(TemporalAdjusters.next(DayOfWeek.THURSDAY));        //다음주 목요일
		System.out.println(dow5);
		LocalDate dow6 = dt.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY)); //오늘이나 다음주 목요일
		System.out.println(dow6);
		LocalDate dow7 = dt.with(TemporalAdjusters.dayOfWeekInMonth(3, DayOfWeek.THURSDAY)); //3번째 목요일
		...
		System.out.println(lTime1.until(lTime2, ChronoUnit.MINUTES));
		System.out.println(lTime1.until(lTime2, ChronoUnit.SECONDS));
		...
		DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 E요일 a HH시mm분").withLocale(Locale.forLanguageTag("ko	"));
