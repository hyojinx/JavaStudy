...
public class HashSetMachRun {
	public static void main(String[] args) {
		...
		Food1 f11 = new Food1("떡복이","분식");
		Food1 f12 = new Food1("떡복이","분식");
		hs1.add(f11);
		hs1.add(f12);
		...
		Food2 f21 = new Food2("떡복이","분식");
		Food2 f22 = new Food2("떡복이","분식");
		hs2.add(f21);
		hs2.add(f22);
		...
		Food3 f31 = new Food3("떡복이","분식");
		Food3 f32 = new Food3("떡복이","분식");
		hs3.add(f31);
		hs3.add(f32);
